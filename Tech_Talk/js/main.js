$(function(){
	...
	$("#post_answer_form").submit(function(event){
		...
		$.ajax({
			url : "https://localhost/CW/Tech_Talk/index.php/answers/post_answer",
			type : "POST",
			...
			success : function(data){
				...
				if(data.proceed){
					$.ajax({
						url : "https://localhost/CW/Tech_Talk/index.php/questions/view_question/"+question_id,
						type : "POST",
	...
	$("#search_term").keyup(function(event){
		...
		if(term != "" && term != null){
			$.ajax({
				url : "https://localhost/CW/Tech_Talk/index.php/guest_search/term/"+encodeURIComponent(term),
				type : "GET",
				success : function(data){
	...
	$(".delete").click(function(event){
		...
		var question_id = $("#question").attr("data-question_id");
		location.href = "https://localhost/CW/Tech_Talk/index.php/questions/delete/"+question_id;
	});
	...
	$("#header_form").submit(function(event){
		...
		if(search_term != "" && search_term != null){
			...
			location.href = "https://localhost/CW/Tech_Talk/index.php/search/term/" +encodeURIComponent(search_term);
		}
		else{
			return false;
		}
...
$(document).on("click",".up,.down",function(){
	...
	$.ajax({
		url : "https://localhost/CW/Tech_Talk/index.php/answers/update_rating",
		type : "POST",
