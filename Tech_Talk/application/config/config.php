...
$config['sess_expiration'] = 7200; // This is the session expiration time in seconds
...
$config['cookie_httponly'] = FALSE; // Set to TRUE to make the cookie accessible via HTTP(S) only
