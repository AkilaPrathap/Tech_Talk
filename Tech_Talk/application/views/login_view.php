...
<body>
    <div class="login-wrap">
        <div class="login-html">
            ...
            <input id="tab-1" type="radio" name="tab" class="sign-up" checked><label for="tab-1" class="tab">login</label>
            <div class="login-form">
                ...
                <div class="sign-up-htm">
                    ...
                    <div class="foot-lnk">
                        ...
                        echo "Do not have an account? ";
                        echo "<a href=\"https://localhost/CW/Tech_Talk/index.php/register\">Register</a>";
                        ?>
                    </div>
                </div>
            </div>
